...
;(function(factory) {
    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                centerPadding: "50px",
                cssEase: "ease",
                customPaging: function(element, settings) {
                    return '<button type="button" data-role="none" role="button" aria-required="false" tabindex="0">' + (settings + 1) + "</button>";
                },
                dots: !1,
    ...
    Slick.prototype.buildOut = function() {
        ...
        _.$slides =
            _.$slider
                ...
                .addClass('banner-container slick-slide');
    ...
    Slick.prototype.setDimensions = function() {
        ...
        if (_.options.vertical === false) {
            if (_.options.centerMode === true) {
                _.$list.css({
                    padding: ('0px ' + _.options.centerPadding + '50px ')
                });
            }
        } else {
		...
		_.$slideTrack.children('.slick-slide').removeAttr('style');
